...
const VEHICLE_STATE_TRANSITIONS = (function() {
  ...
  t[VEHICLE_STATE.WAITING_CHUNK]  = [VEHICLE_STATE.CHUNK_LOADED, VEHICLE_STATE.IDLE]
  t[VEHICLE_STATE.CHUNK_LOADED]   = [VEHICLE_STATE.DEPLOYED, VEHICLE_STATE.IDLE]
  t[VEHICLE_STATE.DEPLOYED]       = [VEHICLE_STATE.TIMING, VEHICLE_STATE.OVER_CAPACITY, VEHICLE_STATE.IDLE]
  t[VEHICLE_STATE.OVER_CAPACITY]  = [VEHICLE_STATE.DEPLOYED, VEHICLE_STATE.IDLE]
  t[VEHICLE_STATE.UNDER_CAPACITY] = [VEHICLE_STATE.IDLE, VEHICLE_STATE.WAITING_CHUNK, VEHICLE_STATE.TIMING]
  t[VEHICLE_STATE.TIMING]         = [VEHICLE_STATE.WAITING_CHUNK, VEHICLE_STATE.IDLE]
  return t
})()
