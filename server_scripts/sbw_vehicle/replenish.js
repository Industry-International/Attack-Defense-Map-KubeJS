...
//
// 核心逻辑：
//   由 ServerEvents.loaded 注册的定时循环驱动，每个 checkInterval
//   tick 执行一次全量检测。
//
//   对每辆载具，流程如下：
//     1. 读取当前状态 & 实际存活数
...
//   DEPLOYED → TIMING（载具死亡）/ OVER_CAPACITY（超量）
//   TIMING → WAITING_CHUNK / IDLE（倒计时结束）
//   OVER_CAPACITY → DEPLOYED / IDLE（超量清除后）
