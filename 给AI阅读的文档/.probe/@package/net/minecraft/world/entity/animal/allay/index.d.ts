...
import { $EntityType_, $Pose, $PortalProcessor, $Entity, $PathfinderMob, $EntityDimensions, $Entity$RemovalReason, $LivingEntity, $WalkAnimationState } from "@package/net/minecraft/world/entity";
