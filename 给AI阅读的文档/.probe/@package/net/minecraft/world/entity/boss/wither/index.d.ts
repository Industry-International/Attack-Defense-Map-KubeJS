...
import { $EntityDimensions, $PowerableMob, $EntityType_, $Entity$RemovalReason, $LivingEntity, $Pose, $PortalProcessor, $WalkAnimationState, $Entity } from "@package/net/minecraft/world/entity";
