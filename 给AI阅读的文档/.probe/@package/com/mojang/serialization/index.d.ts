...
declare module "@package/com/mojang/serialization" {
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.EnchantmentProviderType | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenMaterialRule | RegistryTypes.WorldgenBiomeSource | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.EntitySubPredicateType | RegistryTypes.BlockType | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.NeoforgeStructureModifierSerializers;
