...
declare module "@package/com/mojang/serialization" {
    ...
    export interface $MapCodec extends RegistryMarked<RegistryTypes.NeoforgeBiomeModifierSerializersTag, RegistryTypes.NeoforgeBiomeModifierSerializers> {}
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.WorldgenMaterialRule | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.EntitySubPredicateType | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.WorldgenBiomeSource | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.BlockType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.EnchantmentProviderType | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.NeoforgeBiomeModifierSerializers;
