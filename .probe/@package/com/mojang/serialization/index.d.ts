...
declare module "@package/com/mojang/serialization" {
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.EnchantmentProviderType | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.WorldgenBiomeSource | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.BlockType | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.EntitySubPredicateType | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenMaterialRule | RegistryTypes.NeoforgeBiomeModifierSerializers;
