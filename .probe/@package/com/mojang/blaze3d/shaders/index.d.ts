...
declare module "@package/com/mojang/blaze3d/shaders" {
    ...
    export class $Program$Type extends $Enum<$Program$Type> implements $ProgramTypeAccessor$1, $ProgramTypeAccessor {
        ...
        getExtension(): string;
        static createProgramType$ldlib2_$md$6ffaf3$1(arg0: string, arg1: number, arg2: string, arg3: string, arg4: number): $Program$Type;
        static createProgramType$iris_$md$6ffaf3$0(arg0: string, arg1: number, arg2: string, arg3: string, arg4: number): $Program$Type;
