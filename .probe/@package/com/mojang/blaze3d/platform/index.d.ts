...
declare module "@package/com/mojang/blaze3d/platform" {
    ...
    export class $GlStateManager implements $GlStateManagerAccessor {
        ...
        static getActiveTexture$iris_$md$5bc4b9$3(): number;
        static getTEXTURES$iris_$md$5bc4b9$4(): $GlStateManager$TextureState[];
        static getCOLOR_MASK$iris_$md$5bc4b9$1(): $GlStateManager$ColorMask;
        ...
        static getDEPTH$iris_$md$5bc4b9$2(): $GlStateManager$DepthState;
        static getBLEND$iris_$md$5bc4b9$0(): $GlStateManager$BlendState;
        ...
        constructor();
        static get activeTexture$iris_$md$5bc4b9$3(): number;
        static get TEXTURES$iris_$md$5bc4b9$4(): $GlStateManager$TextureState[];
        static get COLOR_MASK$iris_$md$5bc4b9$1(): $GlStateManager$ColorMask;
        static get boundFramebuffer(): number;
        static get DEPTH$iris_$md$5bc4b9$2(): $GlStateManager$DepthState;
        static get BLEND$iris_$md$5bc4b9$0(): $GlStateManager$BlendState;
    }
    ...
    export class $InputConstants$Key implements $AccessInputConstantsKey {
        ...
        static getNAME_MAP$controlling_$md$5bc4b9$0(): $Map<any, any>;
        getNumericKeyValue(): $OptionalInt;
        displayName: $LazyLoadedValue<$Component>;
        get name(): string;
        get value(): number;
        get type(): $InputConstants$Type;
        static get NAME_MAP$controlling_$md$5bc4b9$0(): $Map<any, any>;
