...
declare module "@package/com/mojang/blaze3d/platform" {
    ...
    export class $GlStateManager implements $GlStateManagerAccessor {
        ...
        static getTEXTURES$iris_$md$d64506$4(): $GlStateManager$TextureState[];
        static getCOLOR_MASK$iris_$md$d64506$1(): $GlStateManager$ColorMask;
        static getActiveTexture$iris_$md$d64506$3(): number;
        static getDEPTH$iris_$md$d64506$2(): $GlStateManager$DepthState;
        static getBLEND$iris_$md$d64506$0(): $GlStateManager$BlendState;
        ...
        static get TEXTURES$iris_$md$d64506$4(): $GlStateManager$TextureState[];
        static get COLOR_MASK$iris_$md$d64506$1(): $GlStateManager$ColorMask;
        static get activeTexture$iris_$md$d64506$3(): number;
        static get DEPTH$iris_$md$d64506$2(): $GlStateManager$DepthState;
        static get BLEND$iris_$md$d64506$0(): $GlStateManager$BlendState;
    }
    ...
    export class $InputConstants$Key implements $AccessInputConstantsKey {
        ...
        static getNAME_MAP$controlling_$md$d64506$0(): $Map<any, any>;
        displayName: $LazyLoadedValue<$Component>;
        get name(): string;
        get value(): number;
        get type(): $InputConstants$Type;
        get numericKeyValue(): $OptionalInt;
        static get NAME_MAP$controlling_$md$d64506$0(): $Map<any, any>;
    }
    ...
    export class $Window implements $AutoCloseable, $MainWindowAccessor, $NativeWindowHandle, $WindowKJS, $WindowExt {
        ...
        handler$ioj000$axiom$getScreenWidth(cir: $CallbackInfoReturnable<any>): void;
        modify$bkk000$veil$modifyMinorVersion(arg0: number, arg1: $LocalIntRef): number;
        handler$ioj000$axiom$getScreenHeight(cir: $CallbackInfoReturnable<any>): void;
        modify$blm000$veil$captureMinorVersion(arg0: number, arg1: $LocalIntRef): number;
        modify$blm000$veil$captureMajorVersion(arg0: number, arg1: $LocalIntRef): number;
        handler$dof000$modernui$onCalculateScale(guiScaleIn: number, forceUnicode: boolean, ci: $CallbackInfoReturnable<any>): void;
        handler$ioj000$axiom$calculateScale(scale: number, forceEven: boolean, cir: $CallbackInfoReturnable<any>): void;
        handler$ioj000$axiom$onResizeInject(l: number, i: number, j: number, ci: $CallbackInfo): void;
        modify$bkk000$veil$modifyMajorVersion(arg0: number, arg1: $LocalIntRef): number;
        ...
        handler$ijp000$imblocker$tweakFullScreenWindowStyle(arg0: $CallbackInfo): void;
        wrapOperation$dbd000$sodium$setAdditionalWindowHints(arg0: number, arg1: number, arg2: $CharSequence, arg3: number, arg4: number, arg5: $Operation_<any>): number;
        constant$cgh000$acceleratedrendering$modifyGlMinorVersion(arg0: number): number;
        constant$cgh000$acceleratedrendering$modifyGlMajorVersion(arg0: number): number;
        setPreferredFullscreenVideoMode(arg0: ($VideoMode) | undefined): void;
        handler$ioj000$axiom$setGuiScale(d: number, ci: $CallbackInfo): void;
        handler$ioj000$axiom$getWidth(cir: $CallbackInfoReturnable<any>): void;
        handler$ioj000$axiom$getHeight(cir: $CallbackInfoReturnable<any>): void;
        handler$ika000$imblocker$initializeIngameIME(arg0: $WindowEventHandler, arg1: $ScreenManager, arg2: $DisplayData, arg3: string, arg4: string, arg5: $CallbackInfo): void;
        handler$ijm000$imblocker$onScaleFactorChanged(arg0: number, arg1: $CallbackInfo): void;
        handler$ijm000$imblocker$onScaleFactorChanged(arg0: number, arg1: $CallbackInfo): void;
