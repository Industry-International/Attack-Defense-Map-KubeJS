...
declare module "@package/com/simibubi/create/content/contraptions" {
    ...
    export class $AbstractContraptionEntity extends $Entity implements $IEntityWithComplexSpawn, $ICreateContraptionEntity, $AccessorAbstractContraptionEntity, $KinematicContraption {
        ...
        handler$ihl000$create_pattern_schematics$handlePlayerInteraction(arg0: $Player, arg1: $BlockPos_, arg2: $Direction_, arg3: $InteractionHand_, arg4: $CallbackInfoReturnable<any>): void;
        tickActors(): void;
        getAnchorVec(): $Vec3;
    ...
    export class $Contraption implements $ContraptionAccessor, $AccessorContraption, $IContraptionFuel, $ICreateContraption {
        ...
        handler$jcc000$createdieselgenerators$getBlockEntityNBT(arg0: $Level_, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
