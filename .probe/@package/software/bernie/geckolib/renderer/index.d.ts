...
declare module "@package/software/bernie/geckolib/renderer" {
    export class $GeoEntityRenderer<T extends $Entity> extends $EntityRenderer<T> implements $GeoRenderer<T> {
        ...
        handler$cjc000$acceleratedrendering$renderCubesOfBoneFast(arg0: $PoseStack, arg1: $GeoBone, arg2: $VertexConsumer, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
