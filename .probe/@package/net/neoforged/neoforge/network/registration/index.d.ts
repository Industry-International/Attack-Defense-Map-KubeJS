...
declare module "@package/net/neoforged/neoforge/network/registration" {
    ...
    export class $NetworkRegistry implements $NetworkRegistryAccessor {
        ...
        static getPayloadRegistrations$fabric_networking_api_v1_$md$5bc4b9$0(): $Map<any, any>;
        static getSetup$fabric_networking_api_v1_$md$5bc4b9$1(): boolean;
        static setSetup$fabric_networking_api_v1_$md$5bc4b9$2(arg0: boolean): void;
        static SUPPORTED_COMMON_NETWORKING_VERSIONS: $List<number>;
        static get initialServerUnregisterChannels(): $Set<$ResourceLocation>;
        static get payloadRegistrations$fabric_networking_api_v1_$md$5bc4b9$0(): $Map<any, any>;
        static get setup$fabric_networking_api_v1_$md$5bc4b9$1(): boolean;
        static set setup$fabric_networking_api_v1_$md$5bc4b9$2(value: boolean);
    }
}
