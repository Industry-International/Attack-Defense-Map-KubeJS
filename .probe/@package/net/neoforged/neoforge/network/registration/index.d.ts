...
declare module "@package/net/neoforged/neoforge/network/registration" {
    ...
    export class $NetworkRegistry implements $NetworkRegistryAccessor {
        ...
        static getSetup$fabric_networking_api_v1_$md$6ffaf3$1(): boolean;
        static setSetup$fabric_networking_api_v1_$md$6ffaf3$2(arg0: boolean): void;
        static getPayloadRegistrations$fabric_networking_api_v1_$md$6ffaf3$0(): $Map<any, any>;
        static getConnectionType(arg0: $Connection): $ConnectionType;
        ...
        static get setup$fabric_networking_api_v1_$md$6ffaf3$1(): boolean;
        static set setup$fabric_networking_api_v1_$md$6ffaf3$2(value: boolean);
        static get payloadRegistrations$fabric_networking_api_v1_$md$6ffaf3$0(): $Map<any, any>;
