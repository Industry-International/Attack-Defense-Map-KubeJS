...
declare module "@package/net/neoforged/neoforge/client" {
    ...
    export class $ChunkRenderTypeSet implements $Iterable<$RenderType>, $ChunkRenderTypeSetAccessor$1, $ChunkRenderTypeSetAccessor, $ExtendedChunkRenderTypeSet {
        ...
        static setChunkRenderTypesList$aeronautics_$md$6ffaf3$0(arg0: $List_<any>): void;
        static setChunkRenderTypes$aeronautics_$md$6ffaf3$1(arg0: $RenderType[]): void;
        static create$sodium_$md$6ffaf3$2(arg0: $BitSet): $ChunkRenderTypeSet;
        ...
        get empty(): boolean;
        static set chunkRenderTypesList$aeronautics_$md$6ffaf3$0(value: $List_<any>);
        static set chunkRenderTypes$aeronautics_$md$6ffaf3$1(value: $RenderType[]);
        get bits(): $BitSet;
    }
    export class $ItemDecoratorHandler {
        ...
        handler$cie000$acceleratedrendering$startRenderingCustomDecoration(arg0: $GuiGraphics, arg1: $Font, arg2: $ItemStack_, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        handler$cie000$acceleratedrendering$stopRenderingCustomDecorationPart(arg0: $GuiGraphics, arg1: $Font, arg2: $ItemStack_, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    }
