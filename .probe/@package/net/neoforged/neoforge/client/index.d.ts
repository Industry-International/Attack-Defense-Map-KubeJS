...
declare module "@package/net/neoforged/neoforge/client" {
    ...
    export class $ChunkRenderTypeSet implements $Iterable<$RenderType>, $ChunkRenderTypeSetAccessor$1, $ChunkRenderTypeSetAccessor, $ExtendedChunkRenderTypeSet {
        ...
        static setChunkRenderTypesList$aeronautics_$md$5bc4b9$0(arg0: $List_<any>): void;
        static setChunkRenderTypes$aeronautics_$md$5bc4b9$1(arg0: $RenderType[]): void;
        static create$sodium_$md$5bc4b9$2(arg0: $BitSet): $ChunkRenderTypeSet;
        spliterator(): $Spliterator<$RenderType>;
        forEach(arg0: $Consumer_<$RenderType>): void;
        getBits(): $BitSet;
        [Symbol.iterator](): Iterator<$RenderType>
        get empty(): boolean;
        static set chunkRenderTypesList$aeronautics_$md$5bc4b9$0(value: $List_<any>);
        static set chunkRenderTypes$aeronautics_$md$5bc4b9$1(value: $RenderType[]);
        get bits(): $BitSet;
    }
