...
declare module "@package/net/minecraft/client/player" {
    export class $LocalPlayer extends $AbstractClientPlayer implements $LocalPlayerInterface, $AccessorLocalPlayer, $LocalClientPlayerKJS, $PlayerFreezeExtension, $IClientPlayerGunOperator {
        ...
        handler$dkd000$xaerominimap$onTickStart(arg0: $CallbackInfo): void;
        wrapOperation$ibi000$tacz$swapSprintStatus(arg0: $LocalPlayer, arg1: boolean, arg2: $Operation_<any>): void;
        handler$ibi000$tacz$onTickClientSide(arg0: $CallbackInfo): void;
        ...
        isAim(): boolean;
        shoot(): $ShootResult;
        handler$ibi000$tacz$onRespawn(arg0: $CallbackInfo): void;
        getActivePortalLocalTransition(): $Portal$Transition;
        wrapOperation$cck000$vista$suppl$preventMovementWhileOperatingCannon(arg0: $Input, arg1: boolean, arg2: number, arg3: $Operation_<any>): void;
        inspect(): void;
    ...
    export class $AbstractClientPlayer extends $Player implements $AbstractClientPlayerAccessor, $ClientPlayerKJS {
        ...
        handler$ieh000$create_sa$getSkinMixin(arg0: $CallbackInfoReturnable<any>): void;
