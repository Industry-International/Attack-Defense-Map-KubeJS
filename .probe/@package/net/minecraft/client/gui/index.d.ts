...
declare module "@package/net/minecraft/client/gui" {
    export class $Font$StringRenderOutput implements $FormattedCharSink {
        ...
        handler$bon000$chat_heads$chatheads$renderChatHead(i: number, style: $Style, j: number, cir: $CallbackInfoReturnable<any>): void;
        this$0: $Font;
        x: number;
        y: number;
    ...
    export class $GuiGraphics implements $IGuiGraphicsExtension, $IAcceleratedGuiGraphics, $DrawContextAccessor {
        ...
        wrapOperation$cid000$acceleratedrendering$setupBatchingLayers(arg0: $ItemRenderer, arg1: $ItemStack_, arg2: $ItemDisplayContext_, arg3: boolean, arg4: $PoseStack, arg5: $MultiBufferSource_, arg6: number, arg7: number, arg8: $BakedModel, arg9: $Operation_<any>): void;
        handler$cid000$acceleratedrendering$stopRenderDecorationPart(arg0: $Font, arg1: $ItemStack_, arg2: number, arg3: number, arg4: string, arg5: $CallbackInfo): void;
        handler$cid000$acceleratedrendering$startRenderDecorationPart(arg0: $Font, arg1: $ItemStack_, arg2: number, arg3: number, arg4: string, arg5: $CallbackInfo): void;
        handler$cid000$acceleratedrendering$stopRenderingGui(arg0: $LivingEntity, arg1: $Level_, arg2: $ItemStack_, arg3: number, arg4: number, arg5: number, arg6: number, arg7: $CallbackInfo): void;
        handler$cid000$acceleratedrendering$startRenderingGui(arg0: $LivingEntity, arg1: $Level_, arg2: $ItemStack_, arg3: number, arg4: number, arg5: number, arg6: number, arg7: $CallbackInfo): void;
        pose(): $PoseStack;
    ...
    export class $Gui implements $GuiSubtitleOverlayAccess, $GuiAccessor {
        ...
        getGuiTicks(): number;
        wrapWithCondition$ipd000$axiom$blitSelectedHotbar(instance: $GuiGraphics, resourceLocation: $ResourceLocation_, i: number, j: number, k: number, l: number): boolean;
        wrapMethod$bge000$iris$handleHudHidingScreens(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $Operation_<any>): void;
        handler$cie000$acceleratedrendering$flushBatching(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $CallbackInfo): void;
        handler$cie000$acceleratedrendering$startBatching(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $CallbackInfo): void;
        handler$ipd000$axiom$renderSelectedItemName(guiGraphics: $GuiGraphics, adapter_injected_1: number, ci: $CallbackInfo): void;
        ...
        handler$ipd000$axiom$renderCrosshair(guiGraphics: $GuiGraphics, deltaTracker: $DeltaTracker, ci: $CallbackInfo): void;
        renderSelectedItemName(arg0: $GuiGraphics, arg1: number): void;
        handler$ipd00c$axiom$tick(ci: $CallbackInfo): void;
        initModdedOverlays(): void;
        handler$ipd000$axiom$renderHotbar(guiGraphics: $GuiGraphics, deltaTracker: $DeltaTracker, ci: $CallbackInfo): void;
        handler$gap000$pingwheel$render(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $CallbackInfo): void;
        handler$ipd001$axiom$render(guiGraphics: $GuiGraphics, deltaTracker: $DeltaTracker, ci: $CallbackInfo): void;
        handler$fha000$inventoryprofilesnext$postRenderHotbar(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $CallbackInfo): void;
        handler$ipd000$axiom$canRenderCrosshairForSpectator(hitResult: $HitResult, cir: $CallbackInfoReturnable<any>): void;
