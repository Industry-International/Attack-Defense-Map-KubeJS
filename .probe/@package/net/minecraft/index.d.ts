...
declare module "@package/net/minecraft" {
    ...
    export class $SystemReport implements $SystemReportAccessor {
        ...
        static getOPERATING_SYSTEM$create_$md$6ffaf3$2(): string;
        static getJAVA_VERSION$create_$md$6ffaf3$3(): string;
        getEntries(): $Map<string, string>;
        static BYTES_PER_MEBIBYTE: number;
        constructor();
        static get OPERATING_SYSTEM$create_$md$6ffaf3$2(): string;
        static get JAVA_VERSION$create_$md$6ffaf3$3(): string;
