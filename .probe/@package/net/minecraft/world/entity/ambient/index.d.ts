...
import { $AnimationState, $EntityDimensions, $EntityType_, $Entity$RemovalReason, $Pose, $PortalProcessor, $WalkAnimationState, $Mob, $Entity, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
