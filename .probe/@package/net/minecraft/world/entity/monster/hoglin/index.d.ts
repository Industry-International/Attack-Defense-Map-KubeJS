...
import { $EntityDimensions, $EntityType_, $Entity$RemovalReason, $LivingEntity, $Pose, $PortalProcessor, $WalkAnimationState, $Entity, $MobSpawnType_ } from "@package/net/minecraft/world/entity";
