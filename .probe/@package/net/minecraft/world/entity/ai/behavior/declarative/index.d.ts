...
declare module "@package/net/minecraft/world/entity/ai/behavior/declarative" {
    ...
    export class $BehaviorBuilder$Instance<E extends $LivingEntity> implements $Applicative<$BehaviorBuilder$Mu<E>, $BehaviorBuilder$Instance$Mu<E>> {
        ...
        ap4<T1, T2, T3, T4, R>(arg0: $App<$BehaviorBuilder$Mu<E>, $Function4_<T1, T2, T3, T4, R>>, arg1: $App<$BehaviorBuilder$Mu<E>, T1>, arg2: $App<$BehaviorBuilder$Mu<E>, T2>, arg3: $App<$BehaviorBuilder$Mu<E>, T3>, arg4: $App<$BehaviorBuilder$Mu<E>, T4>): $BehaviorBuilder<E, R>;
        lift1<A, R>(arg0: $App<$BehaviorBuilder$Mu<E>, $Function_<A, R>>): $Function<$App<$BehaviorBuilder$Mu<E>, A>, $App<$BehaviorBuilder$Mu<E>, R>>;
        ap3<T1, T2, T3, R>(arg0: $App<$BehaviorBuilder$Mu<E>, $Function3_<T1, T2, T3, R>>, arg1: $App<$BehaviorBuilder$Mu<E>, T1>, arg2: $App<$BehaviorBuilder$Mu<E>, T2>, arg3: $App<$BehaviorBuilder$Mu<E>, T3>): $BehaviorBuilder<E, R>;
