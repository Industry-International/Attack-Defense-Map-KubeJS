...
declare module "@package/net/minecraft/world/entity/npc" {
    ...
    export class $Villager extends $AbstractVillager implements $ReputationEventHandler, $VillagerDataHolder, $CupidLove, $VillagerEntityAccessor {
        ...
        static fabric_setItemFoodValues$fabric_content_registries_v0_$md$d64506$0(arg0: $Map_<any, any>): void;
        static fabric_getGatherableItems$fabric_content_registries_v0_$md$d64506$2(): $Set<any>;
        static fabric_setGatherableItems$fabric_content_registries_v0_$md$d64506$1(arg0: $Set_<any>): void;
        playWorkSound(): void;
        ...
        handler$gnc000$moonlight$reg(arg0: $Brain<any>, arg1: $CallbackInfo): void;
