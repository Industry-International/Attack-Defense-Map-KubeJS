...
declare module "@package/net/minecraft/world/entity/player" {
    ...
    export class $Inventory implements $Container, $Nameable {
        ...
        getFreeSlot(): number;
        handler$inm000$axiom$swapPaintHead(d: number, ci: $CallbackInfo): void;
        ...
        handler$glp000$moonlight$ml$restoreNotDropped(arg0: $CallbackInfo, arg1: $List_<any>, arg2: number): void;
        ...
        handler$glp000$moonlight$ml$fireDropEvent(arg0: $CallbackInfo, arg1: $List_<any>, arg2: number): void;
        wrapOperation$inm000$axiom$setPickedItem(instance: $Inventory, itemStack: $ItemStack_, original: $Operation_<any>): number;
    ...
    export class $Player extends $LivingEntity implements $IPlayerExtension, $EntityLivingBaseAccessor, $EntityPlayerAccessor, $ISettingsStorage, $Trackable, $PlayerTypewriterExtension, $PlayerLaunchedPlungerExtension, $EntityDynamicLightSource, $PlayerFreezeExtension, $PlayerKJS {
        ...
        handler$ioh000$axiom$updatePlayerPose(ci: $CallbackInfo): void;
        handler$ioh000$axiom$getFlyingSpeed(cir: $CallbackInfoReturnable<any>): void;
        canPlayerFitWithinBlocksAndEntitiesWhen(arg0: $Pose_): boolean;
        redirect$hba000$sable$fixRidingBoundingBox(arg0: $AABB_, arg1: $AABB_): $AABB;
        ...
        handler$cfl000$fabric_entity_events_v1$injectElytraCheck(arg0: $CallbackInfoReturnable<any>): void;
        destroyVanishingCursedItems(): void;
        getCurrentItemAttackStrengthDelay(): number;
        tryResetCurrentImpulseContext(): void;
        handler$ioh000$axiom$travel(movementInput: $Vec3_, ci: $CallbackInfo): void;
        ...
        modifyReturnValue$cbj000$vista$modifyIsScoping(arg0: boolean): boolean;
        wrapOperation$ioh000$axiom$tick_isSpectator(instance: $Player, original: $Operation_<any>): boolean;
