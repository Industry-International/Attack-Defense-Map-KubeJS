...
declare module "@package/net/minecraft/world/item" {
    export class $PlaceOnWaterBlockItem extends $BlockItem {
        handler$jam000$axiom$useOn(useOnContext: $UseOnContext, cir: $CallbackInfoReturnable<any>): void;
    ...
    export class $ShearsItem extends $Item {
        ...
        modifyReturnValue$gni000$moonlight$m$mineBlock(arg0: boolean, arg1: $BlockState_): boolean;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        static MAX_BAR_WIDTH: number;
        static BASE_ATTACK_SPEED_ID: $ResourceLocation;
    ...
    export class $AxeItem extends $DiggerItem implements $AxeItemAccessor {
        ...
        static getStrippedBlocks$fabric_content_registries_v0_$md$6ffaf3$0(): $Map<any, any>;
        static setStrippedBlocks$fabric_content_registries_v0_$md$6ffaf3$1(arg0: $Map_<any, any>): void;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        tier: $Tier;
        static MAX_BAR_WIDTH: number;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(arg0: $Tier_, arg1: $Item$Properties);
        static get strippedBlocks$fabric_content_registries_v0_$md$6ffaf3$0(): $Map<any, any>;
        static set strippedBlocks$fabric_content_registries_v0_$md$6ffaf3$1(value: $Map_<any, any>);
    }
    ...
    export class $HoeItem extends $DiggerItem implements $HoeItemAccessor {
        ...
        static getTillingActions$fabric_content_registries_v0_$md$6ffaf3$0(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        /**
         * @deprecated
         */
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(arg0: $Tier_, arg1: $Item$Properties);
        static get tillingActions$fabric_content_registries_v0_$md$6ffaf3$0(): $Map<any, any>;
    }
    ...
    export class $ShovelItem extends $DiggerItem implements $ShovelItemAccessor {
        ...
        static getPathStates$fabric_content_registries_v0_$md$6ffaf3$0(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        tier: $Tier;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(arg0: $Tier_, arg1: $Item$Properties);
        static get pathStates$fabric_content_registries_v0_$md$6ffaf3$0(): $Map<any, any>;
    }
    ...
    export class $CreativeModeTabs implements $AccessorCreativeModeTabs, $CreativeModeTabsAccessor, $CreativeModeTabsAccessor$1 {
        ...
        static getCACHED_PARAMETERS$create_connected_$md$6ffaf3$2(): $CreativeModeTab$ItemDisplayParameters;
        static callBuildAllTabContents$copycats_$md$6ffaf3$3(arg0: $CreativeModeTab$ItemDisplayParameters_): void;
        static callBuildAllTabContents$create_connected_$md$6ffaf3$1(arg0: $CreativeModeTab$ItemDisplayParameters_): void;
        ...
        static getCACHED_PARAMETERS$copycats_$md$6ffaf3$4(): $CreativeModeTab$ItemDisplayParameters;
        static setCACHED_PARAMETERS$railways_$md$6ffaf3$0(arg0: $CreativeModeTab$ItemDisplayParameters_): void;
        ...
        constructor();
        static get CACHED_PARAMETERS$create_connected_$md$6ffaf3$2(): $CreativeModeTab$ItemDisplayParameters;
        static get defaultTab(): $CreativeModeTab;
        static get CACHED_PARAMETERS$copycats_$md$6ffaf3$4(): $CreativeModeTab$ItemDisplayParameters;
        static set CACHED_PARAMETERS$railways_$md$6ffaf3$0(value: $CreativeModeTab$ItemDisplayParameters_);
    }
    ...
    export class $ItemStack implements $DataComponentHolder, $MutableDataComponentHolder, $IItemStackExtension, $ItemStackExtensions$1, $ItemStackExtensions, $FabricItemStack, $ItemStackKJS {
        ...
        handler$jao000$axiom$addAttributeTooltips(consumer: $Consumer_<any>, player: $Player, ci: $CallbackInfo): void;
        getPopTime(): number;
    ...
    export class $BlockItem extends $Item implements $InvokerBlockItem, $IExtendedItem {
        ...
        wrapOperation$jaf000$axiom$place$getPlacementState(instance: $BlockItem, blockPlaceContext: $BlockPlaceContext, original: $Operation_<any>): $BlockState;
        placeBlock(arg0: $BlockPlaceContext, arg1: $BlockState_): boolean;
        mustSurvive(): boolean;
        getPlacementState(arg0: $BlockPlaceContext): $BlockState;
        wrapOperation$jaf000$axiom$place$updatePlacementContext(instance: $BlockItem, blockPlaceContext: $BlockPlaceContext, original: $Operation_<any>): $BlockPlaceContext;
        modifyReturnValue$jaf000$axiom$canPlace(canPlace: boolean, blockPlaceContext: $BlockPlaceContext): boolean;
    ...
    export class $Item implements $FeatureElement, $ItemLike, $IItemExtension, $IrisItemLightProvider, $ItemAccessor, $FabricItem, $ItemExtensions, $InjectedItemExtension, $ItemFTBL, $ItemVariantCache, $IExtendedItem, $ItemInvoker, $ItemKJS {
        ...
        handler$glp000$moonlight$initializeClient(arg0: $Consumer_<any>, arg1: $CallbackInfo): void;
        moonlight$getClientAnimationExtension(): $Object;
        static getPlayerPOVHitResult$sable_$md$6ffaf3$0(arg0: $Level_, arg1: $Player, arg2: $ClipContext$Fluid_): $BlockHitResult;
