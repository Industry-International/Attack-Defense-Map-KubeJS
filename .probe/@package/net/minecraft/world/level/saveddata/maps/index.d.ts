...
declare module "@package/net/minecraft/world/level/saveddata/maps" {
    ...
    export class $MapItemSavedData extends $SavedData implements $StationMapData, $FramedMap$MarkerRemover, $ExpandedMapData {
        ...
        handler$gmg000$moonlight$checkCustomDeco(arg0: $BlockGetter, arg1: number, arg2: number, arg3: $CallbackInfo): void;
        handler$gmg000$moonlight$tickCarriedBy(arg0: $Player, arg1: $ItemStack_, arg2: $CallbackInfo): void;
        handler$gmg000$moonlight$initCustomData(arg0: number, arg1: number, arg2: number, arg3: boolean, arg4: boolean, arg5: boolean, arg6: $ResourceKey_<any>, arg7: $CallbackInfo): void;
        ...
        handler$gmg000$moonlight$save(arg0: $CompoundTag_, arg1: $HolderLookup$Provider, arg2: $CallbackInfoReturnable<any>): void;
        handler$gmg000$moonlight$scaled(arg0: $CallbackInfoReturnable<any>): void;
        handler$gmg000$moonlight$locked(arg0: $CallbackInfoReturnable<any>): void;
        ...
        modifyReturnValue$gmg000$moonlight$ml$isExplorationMap(arg0: boolean): boolean;
    ...
    export class $MapItemSavedData$HoldingPlayer implements $IHoldingPlayerExtension {
        handler$glb000$moonlight$checkLocked(arg0: $MapId_, arg1: $CallbackInfoReturnable<any>): void;
        handler$glb000$moonlight$sanityCheck(arg0: number, arg1: number, arg2: $CallbackInfo): void;
        handler$glb000$moonlight$initializeDirty(arg0: $MapItemSavedData, arg1: $Player, arg2: $CallbackInfo): void;
        ...
        handler$glb000$moonlight$lockData(arg0: number, arg1: number, arg2: $CallbackInfo): void;
        nextUpdatePacket(arg0: $MapId_): $Packet<never>;
        markColorsDirty(arg0: number, arg1: number): void;
        modifyReturnValue$glb000$moonlight$addExtraPacketData(arg0: $Packet<any>, arg1: $MapId_): $Packet<any>;
