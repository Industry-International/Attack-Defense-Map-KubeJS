...
declare module "@package/net/caffeinemc/mods/sodium/client/render" {
    export class $SodiumWorldRenderer implements $SodiumWorldRendererExtension$1, $SodiumWorldRendererAccessor, $SodiumWorldRendererExtension {
        ...
        handler$cnj000$aeronautics$setupLevititeShaders(arg0: $RenderType, arg1: $ChunkRenderMatrices_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        handler$hhh000$sable$isTerrainRenderComplete(arg0: $CallbackInfoReturnable<any>): void;
        handler$hhh000$sable$scheduleRebuildForChunk(arg0: number, arg1: number, arg2: number, arg3: boolean, arg4: $CallbackInfo): void;
        handler$cnj000$aeronautics$cleanupLevititeShaders(arg0: $RenderType, arg1: $ChunkRenderMatrices_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        isEntityVisible(arg0: $Entity): boolean;
        handler$hhh000$sable$markGraphDirty(arg0: $Camera, arg1: $Viewport, arg2: boolean, arg3: boolean, arg4: $CallbackInfo): void;
        sable$getSubLevelRenderSectionManager(arg0: $ClientSubLevel): $SubLevelRenderSectionManager;
        handler$hhh000$sable$drawRenderSources(arg0: $RenderType, arg1: $ChunkRenderMatrices_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        ...
        handler$hhh000$sable$setupTerrain(arg0: $Camera, arg1: $Viewport, arg2: boolean, arg3: boolean, arg4: $CallbackInfo): void;
